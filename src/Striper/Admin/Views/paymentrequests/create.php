...
<form id="detail-form" class="form" method="post">
    ...
    <div class="clearfix">
        ...
        <div class="pull-right">
            ...
            &nbsp;
            <a class="btn btn-default" href="./admin/striper/paymentrequests">Cancel</a>
        </div>
    ...
    <ul class="nav nav-tabs">
        ...
        <li >
            <a href="#tab-client" data-toggle="tab">Client </a>
        </li>
        <li >
            <a href="#tab-items" data-toggle="tab">Billing Items </a>
        </li>
    ...
    <div class="tab-content padding-10">
    	<div class="tab-pane active" id="tab-details">
            ...
            <?php echo $this->renderLayout('Striper/Admin/Views::paymentrequests/details.php'); ?>
                                
        </div>
        <div class="tab-pane" id="tab-client">
        
            <?php echo $this->renderLayout('Striper/Admin/Views::paymentrequests/client.php'); ?>
        ...
        <div class="tab-pane" id="tab-items">
            <?php echo $this->renderLayout('Striper/Admin/Views::paymentrequests/items.php'); ?>        
        </div>
        <!-- /.tab-pane -->

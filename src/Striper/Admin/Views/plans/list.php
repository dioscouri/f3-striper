...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-table fa-fw "></i> Subscription Plans <span> > List </span>
        </h1>
    </div>
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11">
                        	<div class="row">
					        	...
					        	<?php if( $allow_preview ) { ?>
			                        <a class="btn btn-xs btn-warning" target="_blank" href="./striper/plans/<?php echo $item->id; ?>?preview=1">

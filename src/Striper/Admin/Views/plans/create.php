...
<form id="detail-form" class="form" method="post">
    ...
    <div class="clearfix">
        ...
        <div class="pull-right">
            ...
            &nbsp;
            <a class="btn btn-default" href="./admin/striper/plans">Cancel</a>
        </div>
    ...
    <ul class="nav nav-tabs">
    	<li class="active">
            <a href="#tab-details" data-toggle="tab">Plan </a>
        </li>
        <li >
            <a href="#tab-client" data-toggle="tab">Site </a>
        </li>
    ...
    <div class="tab-content padding-10">
    	<div class="tab-pane active" id="tab-details">
            ...
            <?php echo $this->renderLayout('Striper/Admin/Views::plans/stripe_plan.php'); ?>
                                
        </div>
        <div class="tab-pane" id="tab-client">
        
            <?php echo $this->renderLayout('Striper/Admin/Views::plans/site.php'); ?>

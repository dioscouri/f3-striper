...
<form id="detail-form" class="form" method="post">
    ...
    <div class="clearfix">
        ...
        <div class="pull-right">
            ...
            &nbsp;
            <a class="btn btn-default" href="./admin/striper/subscriptions">Cancel</a>
        </div>
    ...
    <div class="tab-content padding-10">
    	<div class="tab-pane active" id="tab-details">
            ...
            <?php echo $this->renderLayout('Striper/Admin/Views::subscriptions/details.php'); ?>
                                
        </div>
        <div class="tab-pane" id="tab-client">
        
            <?php echo $this->renderLayout('Striper/Admin/Views::subscriptions/client.php'); ?>
        ...
        <div class="tab-pane" id="tab-items">
            <?php echo $this->renderLayout('Striper/Admin/Views::subscriptions/items.php'); ?>        
        </div>
        <!-- /.tab-pane -->

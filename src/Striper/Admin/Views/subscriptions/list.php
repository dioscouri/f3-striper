...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-table fa-fw "></i> Subscriptions <span> > List </span>
        </h1>
    </div>
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
        <ul id="sparks" class="list-actions list-unstyled list-inline">
            <li>
                <a class="btn btn-default" href="./admin/striper/subscription/create">Add New</a>
            </li>
        </ul>
    </div>
</div>
                    ...
                    <div class="input-group">
                        <select id="bulk-actions" name="bulk_action" class="form-control">
                            <option value="null">-Bulk Actions-</option>
                                <option value="delete" data-action="./admin/striper/subscriptions/delete">Delete</option>
                        </select>
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11">
                        	<div class="row">
                        		<div class="hidden-xs hidden-sm col-md-3 col-lg-3">
                        			...
                        			<a href="./admin/striper/subscription/edit/<?php echo $item->id; ?>" title="<?php echo $item->title; ?>">
                        		...
                        		<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        			<div class="row">
		                        		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        					<legend><a href="./admin/striper/subscription/edit/<?php echo $item->id; ?>"><?php echo $item->title; ?></a></legend>
		                        		</div>
                        			</div>
                        			<div class="row">
		                        		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
		                        			<div>
		                        				<label>Slug:</label> <a target="_blank" href="./striper/subscription/<?php echo $item->id; ?>"><?php echo $item->id; ?> <i class="fa fa-external-link"></i></a>
		                        			</div>
					        	...
					        	<?php if( $allow_preview ) { ?>
			                        <a class="btn btn-xs btn-warning" target="_blank" href="./striper/subscriptions/<?php echo $item->id; ?>?preview=1">
			                            <i class="fa fa-search"></i>
			                        </a>
			        	            &nbsp;
					            <?php } ?>
			                        <a class="btn btn-xs btn-danger" data-bootbox="confirm" target="_blank" href="./admin/striper/subscription/delete/<?php echo $item->id; ?>">

...
class PaymentRequest extends \Admin\Controllers\BaseAuth 
{
    use \Dsc\Traits\Controllers\CrudItemCollection;
    use \Dsc\Traits\Controllers\SupportPreview;

    protected $list_route = '/admin/striper/paymentrequests';
    protected $create_item_route = '/admin/striper/paymentrequest/create';
    protected $get_item_route = '/admin/striper/paymentrequest/read/{id}';    
    protected $edit_item_route = '/admin/striper/paymentrequest/edit/{id}';
    ...
    protected function displayCreate() 
    {
        ...
        */
        ...
        $view->event = $view->trigger( 'onDisplayPaymentRequestsEdit', array( 'item' => $item, 'tabs' => array(), 'content' => array() ) );
        
        echo $view->render('Striper/Admin/Views::paymentrequests/create.php');
    }
    ...
    protected function displayEdit()
    {
        ...
        */
        ...
        echo $view->render('Striper/Admin/Views::paymentrequests/edit.php');
    }
